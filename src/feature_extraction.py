...
data_root = "C:\\Users\\percy\\Documents\\HackAI\\HackAI-Wildlife-Monitoring\\data"  
...
df.to_csv("acoustic_features_24.csv", index=False)
print("Feature extraction complete. Saved to acoustic_features_24.csv")